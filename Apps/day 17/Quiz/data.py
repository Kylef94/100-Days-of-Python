...
q_data = requests.get(url='https://opentdb.com/api.php?amount=10&type=boolean')
question_data = []
q_data = q_data.json()
q_data = q_data['results']

for d in q_data:
    question_data.append({'question': d['question'], 'answer': d['correct_answer']})
